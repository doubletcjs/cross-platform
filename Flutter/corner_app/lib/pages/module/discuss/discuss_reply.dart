...
import 'package:corner_app/pages/module/discuss/views/discuss_reply_cell.dart';
import 'package:corner_app/public/public.dart';
import 'package:flutter/material.dart';

class DiscussReply extends StatefulWidget {
  DiscussReply({Key key}) : super(key: key);

  @override
  _DiscussReplyState createState() => _DiscussReplyState();
...
class _DiscussReplyState extends State<DiscussReply> {
  // 评论
  void _discussPost() {
    DiscussInput(
      postHandle: (text) {
