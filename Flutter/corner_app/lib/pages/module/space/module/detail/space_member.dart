...
class SpaceDetailMember extends StatefulWidget {
  SpaceDetailMember({Key key}) : super(key: key);

  @override
  _SpaceDetailMemberState createState() => _SpaceDetailMemberState();
}

class _SpaceDetailMemberState extends State<SpaceDetailMember> {
  List _dataList = [
    {
      "cover": "",
      "name": "红鱼",
