...
class StoreApplyDetail extends StatefulWidget {
  Map account;
  StoreApplyDetail({Key key, this.account}) : super(key: key);

  @override
  _StoreApplyDetailState createState() => _StoreApplyDetailState();
}

class _StoreApplyDetailState extends State<StoreApplyDetail> {
  // 黑名单
