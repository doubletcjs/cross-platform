...
class StoreInfoEdit extends StatefulWidget {
  StoreInfoEdit({Key key}) : super(key: key);

  @override
  _StoreInfoEditState createState() => _StoreInfoEditState();
}

class _StoreInfoEditState extends State<StoreInfoEdit> {
