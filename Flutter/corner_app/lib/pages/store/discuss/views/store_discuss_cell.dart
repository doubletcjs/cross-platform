import 'package:corner_app/pages/store/discuss/store_discuss_reply.dart';
import 'package:corner_app/public/public.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class StoreDiscussCell extends StatefulWidget {
  ...
  @override
  _StoreDiscussCellState createState() => _StoreDiscussCellState();
}

class _StoreDiscussCellState extends State<StoreDiscussCell> {
  // 已打开全文
  ...
  Widget _commentFill(String text, double maxWidth) {
    ...
    return _expansion == true
        ? RichText(
            ...
            text: TextSpan(
              text: text.substring(0, _endOffset - 2) + "...  ",
              style: _style,
              children: [
                TextSpan(
                  text: "展开",
  ...
  // 回复列表
  void _replyList() {
    StoreDiscussReply().show(context);
  }
