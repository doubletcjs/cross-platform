...
//    private static final String SECRETKEY = "";
     ...
     * 文档：https://cloud.tencent.com/document/product/269/32688#Server
     */
    public static String genUserSig(String userId, String appId, String secretKey) {
        return GenTLSSignature(appId, userId, EXPIRETIME, null, secretKey);
    }
     ...
     */
    private static String GenTLSSignature(String appId, String userId, long expire, byte[] userbuf, String priKeyContent) {
        ...
        String sig = hmacsha256(java.lang.Long.valueOf(appId), userId, currTime, expire, priKeyContent, base64UserBuf);
        if (sig.length() == 0) {
            return "";
        }
        try {
