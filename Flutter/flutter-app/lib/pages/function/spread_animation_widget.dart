...
class SpreadAnimationWidget extends StatefulWidget {
  SpreadAnimationWidget({
    this.child,
  ...
  @override
  _SpreadAnimationWidgetState createState() => _SpreadAnimationWidgetState();
}

class _SpreadAnimationWidgetState extends State<SpreadAnimationWidget>
