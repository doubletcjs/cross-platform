...
///
///
/// flutter_cupertino_data_picker的改写版。原插件无法指定默认选择项 _initialIndex
...
class _DatePickerState extends State<_DataPickerComponent> {
  ...
  void _notifyDateChanged() {
    if (widget.onChanged != null) {
      widget.onChanged(widget.dataList[_initialIndex]);
    }
  }
              ...
              return Container(
                ...
                child: Row(
                  children: <Widget>[
                    new Expanded(
                        child: Text(
                      '${widget.dataList[index]}$suffixAppend',
                      style: TextStyle(
            ...
            child: FlatButton(
              ...
              onPressed: () {
                if (widget.route.onConfirm != null) {
                  widget.route.onConfirm(widget.dataList[_initialIndex]);
                }
