<template>
	<view>
		...
		<view class="edit-base-header">
			...
			<image :src="cover.length == 0 ? '/static/images/creation_image_cover@3x.png' : cover" mode="aspectFill"
			 class="edit-base-header-cover"></image>
			<!-- 选择图片 -->
	...
	export default {
		...
		methods: {
			...
			inputContentAction(type) {
				var content = type == 0 ? this.name : this.introduction
				uni.navigateTo({
					url: "detail_edit_input?type=" + type + "&content=" + content
				})
			}
		},
		onShow() {
