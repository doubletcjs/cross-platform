  ...
  handleData() {
    if (this.data.currentTab == 0) {
      let list = [{
          ...
          totalnum: '1',
          totalprice: '266.00',
          status: 1, // 1 等待付款 2 等待卖家发货 3 卖家已发货 4 交易成功 5 交易关闭 6  售后 退货退款
          shopings: [{
        ...
        },
        {
          ...
          totalnum: '1',
          totalprice: '2266.00',
          status: 2, // 1 等待付款 2 等待卖家发货 3 卖家已发货 4 交易成功 5 交易关闭 6  售后 退货退款 
          shopings: [{
            imgsrc: '/icons/icon-profile-product-placeholder@3x.png',
            orderTitle: '扫拖不用亲自动 扫拖不用亲自动扫拖不用亲自动拖两用机器人...',
            orderContent: ' 盐湖白，购买扫 购买扫地机器人 送蓝色收纳袋送蓝色收纳袋送',
        ...
        },
        {
          ...
          totalnum: '1',
          totalprice: '72.00',
          status: 3, // 1 等待付款 2 等待卖家发货 3 卖家已发货 4 交易成功 5 交易关闭 6  售后 退货退款
          shopings: [{
            imgsrc: '/icons/icon-profile-product-placeholder@3x.png',
            orderTitle: '扫拖不用亲自动 扫拖不用亲自动扫拖不用亲自动拖两用机器人...',
            orderContent: ' 盐湖白，购买扫 购买扫地机器人 送蓝色收纳袋送蓝色收纳袋送',
        ...
        },
        {
          ...
          totalnum: '1',
          totalprice: '148.00',
          status: 4, // 1 等待付款 2 等待卖家发货 3 卖家已发货 4 交易成功 5 交易关闭 6  售后 退货退款
          shopings: [{
            imgsrc: '/icons/icon-profile-product-placeholder@3x.png',
            orderTitle: '扫拖不用亲自动 扫拖不用亲自动扫拖不用亲自动拖两用机器人...',
            orderContent: ' 盐湖白，购买扫 购买扫地机器人 送蓝色收纳袋送蓝色收纳袋送',
        ...
        },
        {
          ...
          totalnum: '1',
          totalprice: '149.00',
          status: 5, // 1 等待付款 2 等待卖家发货 3 卖家已发货 4 交易成功 5 交易关闭  6  售后 退货退款
          shopings: [{
            imgsrc: '/icons/icon-profile-product-placeholder@3x.png',
            orderTitle: '扫拖不用亲自动 扫拖不用亲自动扫拖不用亲自动拖两用机器人...',
            orderContent: ' 盐湖白，购买扫 购买扫地机器人 送蓝色收纳袋送蓝色收纳袋送',
      ...
      let list = [{
          ...
          totalnum: '1',
          totalprice: '148.00',
          status: 6, // 1 等待付款 2 等待卖家发货 3 卖家已发货 4 交易成功 5 交易关闭 6  售后 退货 7 退款
          shopings: [{
            imgsrc: '/icons/icon-profile-product-placeholder@3x.png',
            orderTitle: '扫拖不用亲自动 扫拖不用亲自动扫拖不用亲自动拖两用机器人...',
            orderContent: ' 盐湖白，购买扫 购买扫地机器人 送蓝色收纳袋送蓝色收纳袋送',
        ...
        },
        {
          ...
          totalnum: '1',
          totalprice: '148.00',
          status: 7, // 1 等待付款 2 等待卖家发货 3 卖家已发货 4 交易成功 5 交易关闭 6  售后 退货 7 退款
          shopings: [{
            imgsrc: '/icons/icon-profile-product-placeholder@3x.png',
            orderTitle: '扫拖不用亲自动 扫拖不用亲自动扫拖不用亲自动拖两用机器人...',
            orderContent: ' 盐湖白，购买扫 购买扫地机器人 送蓝色收纳袋送蓝色收纳袋送',
